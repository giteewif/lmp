...
import sllm_store.proto.storage_pb2 as storage__pb2
...
class StorageStub(object):
    ...
    def __init__(self, channel):
        ...
        self.RegisterFixedGpuPtrs = channel.unary_unary(
                '/storage.Storage/RegisterFixedGpuPtrs',
                request_serializer=storage__pb2.RegisterFixedGpuPtrsRequest.SerializeToString,
                response_deserializer=storage__pb2.RegisterFixedGpuPtrsResponse.FromString,
                )
        self.ReleaseRegisteredFixedGpuPtrs = channel.unary_unary(
                '/storage.Storage/ReleaseRegisteredFixedGpuPtrs',
                request_serializer=storage__pb2.ReleaseRegisteredFixedGpuPtrsRequest.SerializeToString,
                response_deserializer=storage__pb2.ReleaseRegisteredFixedGpuPtrsResponse.FromString,
                )
        self.ReleaseAllRegisteredFixedGpuPtrs = channel.unary_unary(
                '/storage.Storage/ReleaseAllRegisteredFixedGpuPtrs',
                request_serializer=storage__pb2.RegisterFixedGpuPtrsRequest.SerializeToString,
                response_deserializer=storage__pb2.ReleaseRegisteredFixedGpuPtrsResponse.FromString,
                )
...
class StorageServicer(object):
    ...
    def RegisterFixedGpuPtrs(self, request, context):
    ...
    def ReleaseRegisteredFixedGpuPtrs(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')

    def ReleaseAllRegisteredFixedGpuPtrs(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_StorageServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'RegisterFixedGpuPtrs': grpc.unary_unary_rpc_method_handler(
                    servicer.RegisterFixedGpuPtrs,
                    request_deserializer=storage__pb2.RegisterFixedGpuPtrsRequest.FromString,
                    response_serializer=storage__pb2.RegisterFixedGpuPtrsResponse.SerializeToString,
            ),
            'ReleaseRegisteredFixedGpuPtrs': grpc.unary_unary_rpc_method_handler(
                    servicer.ReleaseRegisteredFixedGpuPtrs,
                    request_deserializer=storage__pb2.ReleaseRegisteredFixedGpuPtrsRequest.FromString,
                    response_serializer=storage__pb2.ReleaseRegisteredFixedGpuPtrsResponse.SerializeToString,
            ),
            'ReleaseAllRegisteredFixedGpuPtrs': grpc.unary_unary_rpc_method_handler(
                    servicer.ReleaseAllRegisteredFixedGpuPtrs,
                    request_deserializer=storage__pb2.RegisterFixedGpuPtrsRequest.FromString,
                    response_serializer=storage__pb2.ReleaseRegisteredFixedGpuPtrsResponse.SerializeToString,
            ),
...
class Storage(object):
    ...
    @staticmethod
    def RegisterFixedGpuPtrs(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/storage.Storage/RegisterFixedGpuPtrs',
            storage__pb2.RegisterFixedGpuPtrsRequest.SerializeToString,
            storage__pb2.RegisterFixedGpuPtrsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def ReleaseRegisteredFixedGpuPtrs(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/storage.Storage/ReleaseRegisteredFixedGpuPtrs',
            storage__pb2.ReleaseRegisteredFixedGpuPtrsRequest.SerializeToString,
            storage__pb2.ReleaseRegisteredFixedGpuPtrsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def ReleaseAllRegisteredFixedGpuPtrs(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/storage.Storage/ReleaseAllRegisteredFixedGpuPtrs',
            storage__pb2.RegisterFixedGpuPtrsRequest.SerializeToString,
            storage__pb2.ReleaseRegisteredFixedGpuPtrsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetModelSharedMemoryNames(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/storage.Storage/GetModelSharedMemoryNames',
